...
export class PerfilUsuarioComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.nombreControl = this.informacionPersonal.get('nombre') as FormControl;
    this.apellidoControl = this.informacionPersonal.get('apellido') as FormControl;
    this.fechaNacimientoControl = this.informacionPersonal.get('fechaNacimiento') as FormControl;
    this.telefonoControl = this.informacionPersonal.get('telefono') as FormControl;
  }
